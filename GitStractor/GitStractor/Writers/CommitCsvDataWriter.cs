...
public class CommitCsvDataWriter : CommitDataWriter
{
    ...
    public override void BeginWriting()
    {
        ...
        _writer.WriteLine("CommitHash,AuthorEmail,AuthorDateUTC,CommitterEmail,CommitterDate,Message,NumFiles,TotalFiles,TotalBytes,FileNames");
    }
    ...
    public override void Write(CommitInfo commit)
    {
        ...
        _writer.WriteLine($"{commit.NumFiles},{commit.TotalFiles},{commit.SizeInBytes},{commit.FileNames.ToCsvSafeString()}");
    }
