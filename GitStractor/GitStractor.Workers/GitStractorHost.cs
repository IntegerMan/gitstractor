...
public class GitStractorHost : IHost {
    ...
    private static readonly Action<ILogger, Exception?> logStarting = LoggerMessage.Define(LogLevel.Information, new EventId(1, "StartingHost"), $"Starting {Name}");
    private static readonly Action<ILogger, Exception?> logStarted = LoggerMessage.Define(LogLevel.Information, new EventId(2, "StartedHost"), $"Started {Name}");
    private static readonly Action<ILogger, Exception?> logStopping = LoggerMessage.Define(LogLevel.Information, new EventId(3, "StoppingHost"), $"Stopping {Name}");
    private static readonly Action<ILogger, Exception?> logStopped = LoggerMessage.Define(LogLevel.Information, new EventId(4, "StoppedHost"), $"Stopped {Name}");
    private static readonly Action<ILogger, Exception?> logStoppedWithExceptions = LoggerMessage.Define(LogLevel.Critical, new EventId(5, "StoppedHost"), $"Stopped {Name} but encountered one or more exceptions stopping workers");
